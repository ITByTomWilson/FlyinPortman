...
<div id="content">
<div>
<h1><img alt="Supported Links" height="50" src="images/links_title.png" width="400" /></h1>

<form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top"><input name="cmd" type="hidden" value="_s-xclick" /> <input name="hosted_button_id" type="hidden" value="Q8LMAB9A5E9ZN" />
<table>
	<tbody>
		<tr>
			<td><input name="on0" type="hidden" value="General Merchandise" />Any merchandising purchases please contact <a href="mailto:admin@flyinportman.com">Admin</a> first to verify inventory.<br />
			&nbsp;</td>
		</tr>
		<tr>
			<td><select name="os0"><option value="Donation Denomination">Donation Denomination $5.00 USD</option><option value="Shirt (Pickup)">Shirt (Pickup) $15.00 USD</option><option value="Shirt (w/ Delivery)">Shirt (w/ Delivery) $20.00 USD</option><option value="2 Shirts (w/ Delivery)">2 Shirts (w/ Delivery) $35.00 USD</option><option value="Donation (w/ Gift Shirt)">Donation (w/ Gift Shirt) $30.00 USD</option> </select></td>
		</tr>
		<tr>
...
<p style="text-align: center;"><input name="currency_code" type="hidden" value="USD" /> <input alt="PayPal - The safer, easier way to pay online!" border="0" name="submit" src="https://www.paypalobjects.com/en_US/i/btn/btn_buynowCC_LG.gif" type="image" /> <img alt="" border="0" height="1" src="https://www.paypalobjects.com/en_US/i/scr/pixel.gif" width="1" /></p>
</form>

<ul id="links">
	<li style="text-align: center;"><a href="faq.html"><img alt="Faq Link" height="106" src="images/faqlink.png" width="150" /></a><a href="faq.html"><img alt="Merchandise Link" height="106" src="images/merchandiselink.png" width="150" /></a></li>
	<li style="text-align: center;"><a href="https://www.gamestop.com/PowerUpRewards/"><img alt="GameStop PowerUp Rewards" height="50" src="images/gspur_logo.png" width="150" /></a></li>
	<li style="text-align: center;"><a href="http://www.original-gamer.com/"><img alt="Original-Gamer.com" height="50" src="images/og_logo.png" width="205" /></a></li>
	<li style="text-align: center;"><a href="http://www.chattanoogastate.edu"><img alt="Chattanooga State Technical Community College" height="50" src="images/chattstate_logo.png" width="156" /></a></li>
</ul>
</div>
</div>
...
<nav><a href="links.php" id="nav_links"><img alt="Supported Links" src="images/nav_links_active.png" width="250" /></a></nav>
</div>
