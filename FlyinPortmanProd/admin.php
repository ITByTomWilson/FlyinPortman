...
<div id="container">
  ...
  <div id="content">
    ...
    <div>
      <h1><img src="images/admin_title.png" height="50" width="400" alt="About Us"></h1>
      </div>
  </div>
    ...
    <div id="sidebar">
        ...
        <nav><a href="staff.php" id="nav_sm"><img src="images/nav_sm.png" width="250" alt="Staff Management"></a></nav>

        <nav><a href="admin.php" id="nav_admin"><img src="images/nav_admin_active.png" width="250" alt="Admin"></a></nav>
