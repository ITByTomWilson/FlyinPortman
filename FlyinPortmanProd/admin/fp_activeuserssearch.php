...
require_once './fp_activeuserssearch_func.php';
...
<head>
<title>Active Users Search</title>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    ...
    <tr>
        <td>
            <form name="art_form" id="art_form" method="post" action="fp_activeuserssearch.php"  style="margin: 0px; padding: 0px;">
                <div id="art_ajaxpanel1">
                    <?php art_form_searchdata_display("art_form", $err_string); ?>
                </div>
            </form>
        </td>
    </tr>
