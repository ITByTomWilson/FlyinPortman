...
require_once './fp_rank_search_func.php';
...
if (($artsv_postback == "1") && ($refresh_view != "1")){
	  ...
	  if ($err_string == "SUCCESS") {
        art_set_session("fp_rank_page", "1");
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    ...
    <tr>
        <td>
            <form name="art_form" id="art_form" method="post" action="fp_rank_search.php"  style="margin: 0px; padding: 0px;">
