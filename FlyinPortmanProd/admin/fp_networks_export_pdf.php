...
$sqlexport = "select * from `fp_networks`";
$pdf->resultset = mysql_query($sqlexport);
$pdf->field_indexs = array(1,2,3);
$pdf->col_titles = array('NetworkName','Enabled','SysDTStamp');
$pdf->col_widths = array('25','25','25');
$pdf->col_align = array('L','L','L');
