...
require_once './fp_activeusers_func.php';
...
if (($artsv_postback == "1") && ($artsv_act_search != "")){
    ...
    if ($quick_search != art_session("fp_activeusers_quick_search", "")){
        art_set_session("fp_activeusers_quick_search", $quick_search);
        art_set_session("fp_activeusers_page", "1");
    }
}
?>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    ...
    <tr>
        <td>
            <form name="art_form" id="art_form" method="post" action="fp_activeusers.php" style="margin: 0px; padding: 0px;">
