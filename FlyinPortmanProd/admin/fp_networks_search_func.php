...
function art_form_searchdata_display($form, $message){
    ...
    $value = $artv_fpnetworkid;
    if (($value == "") || ($value == null)) {
        $value = "";
        $artv_fpnetworkid = $value;
    }
    ...
    print "<td width=\"3\" class=\"formColumnData\">&nbsp;</td>\n";
    print "<td class=\"formColumnData\" align=\"left\">\n";
    print "<input class=\"textbox\" id=\"fpnetworkid\" name=\"fpnetworkid\" type=\"text\" value=\"" . $value . "\"  size=\"25\" maxlength=\"10\" >\n";
    print "</td>\n";
    print "</tr>\n";
    ...
    print "<td width=\"3\" class=\"formColumnData\">&nbsp;</td>\n";
    print "<td class=\"formColumnData\" align=\"left\">\n";
    print "<input class=\"textbox\" id=\"networkname\" name=\"networkname\" type=\"text\" value=\"" . $value . "\"  size=\"25\" maxlength=\"45\" >\n";
    print "</td>\n";
    print "</tr>\n";
    $value = $artv_enabled;
    if (($value == "") || ($value == null)) {
    ...
    print "<td width=\"3\" class=\"formColumnData\">&nbsp;</td>\n";
    print "<td class=\"formColumnData\" align=\"left\">\n";
    print "<input class=\"textbox\" id=\"enabled\" name=\"enabled\" type=\"text\" value=\"" . $value . "\"  size=\"25\" maxlength=\"45\" >\n";
    print "</td>\n";
    print "</tr>\n";
...
function art_search_data(){
    ...
    $fld_name = array();
    $fld_value = array();
    $fld_name[] = "fp_networks.fpNetworkID";
    $fld_type[] = 2;
	  $fld_value[] = art_request("fpnetworkid", "");
    $fld_name[] = "fp_networks.networkName";
    $fld_type[] = 1;
	  $fld_value[] = art_request("networkname", "");
    $fld_name[] = "fp_networks.enabled";
    $fld_type[] = 1;
	  $fld_value[] = art_request("enabled", "");
    $fld_name[] = "fp_networks.sysDTStamp";
    $fld_type[] = 3;
    $artv_sysdtstamp_year = art_request("sysdtstamp_year", "");
    $artv_sysdtstamp_month = art_request("sysdtstamp_month", "");
    $artv_sysdtstamp_day = art_request("sysdtstamp_day", "");
    ...
    if ($result == "") {
        ...
        for ($i=0; $i<$icount; $i++) {
            ...
            if ($sql_where == "") {
		        ...
		        art_set_session('fp_networks_search', $sql_where);
