...
require_once './fp_networks_const.php';
...
function art_datagrid_display($field_names, $page_size, $current_page, $quick_search, $navtype, $category, $showtotalrec=0, $showpagesize=0) {	
    ...
    $qrystr = array_fill(0, 5, "");
    $clr = art_request("clr_fp_networks", "");
    $clr_adv_session = art_request("clr_fp_networks_adv_session", "");

    if (strtolower($clr) == "t"){
        art_clear_session("fp_networks_sort1");	
        art_clear_session("fp_networks_sort2");	
        art_clear_session("fp_networks_sort3");	
        art_clear_session("fp_networks_sort4");	
        art_clear_session("fp_networks_sort5");	
        $clr = "";
	  }

    if (strtolower($clr_adv_session) == "y") {
        $clr_adv_session = "";
        art_clear_session("fp_networks_search");
        art_clear_session("fp_networks_page");
        art_clear_session("fp_networks_quick_search");
        art_clear_session("fp_networks_category");
        $quick_search = "";
        $category = "";
	  }

    art_assign_session("fp_networks_sort1", "");
    art_assign_session("fp_networks_sort2", "");
    art_assign_session("fp_networks_sort3", "");
    art_assign_session("fp_networks_sort4", "");
    art_assign_session("fp_networks_sort5", "");
    art_assign_session("fp_networks_page_size", 20);
    art_assign_session("fp_networks_page", "1");
    $sql_array  = art_split_sql(" select * from `fp_networks`"); 
    $sql_start = $sql_array[0]; 
    $sql_orderby = $sql_array[1]; 
    $sort1 = art_session("fp_networks_sort1", "");
    $sort2 = art_session("fp_networks_sort2", "");
    $sort3 = art_session("fp_networks_sort3", "");
    $sort4 = art_session("fp_networks_sort4", "");
    $sort5 = art_session("fp_networks_sort5", "");
    ...
    for ($i=1; $i<=5; $i++){
        $sorting = "";
        $sort_order = "";
        if (art_session("fp_networks_sort".$i, "") == "1"){
            $sorting = "&fp_networks_sort". $i . "=" . "2";
            $sort_order = "ASC";
        } else if (art_session("fp_networks_sort".$i, "") == "2"){
            $sorting = "&fp_networks_sort". $i . "=" . "1";
            $sort_order = "DESC";
        } else {
            $sorting = "&fp_networks_sort". $i . "=" . "1";
            $sort_order = "";
        }
        $qrystr[$i] = "fp_networks_ajax.php?clr_fp_networks=t".$sorting;
    ...
    $advsearch_sql = art_session("fp_networks_search","");
    if ($advsearch_sql != "") {
    ...
    print "&nbsp;<a href=\"" . art_gen_url("fp_networks_ajax.php?clr_fp_networks=t", 1). "\"" . " title=\"Clear Sort\" class=\"gridToolBarLink\"><img src=\"./images/defaultbutton/clear_sort.gif\" border=\"0\" /></a>";
    print "&nbsp;<a href=\"" . "./fp_networks_search.php". "\"" . " title=\"Advance Search\" class=\"gridToolBarLink\"><img src=\"./images/defaultbutton/adv_search.gif\" border=\"0\" /></a>";
    print "&nbsp;<a href=\"" . "./fp_networks_add.php". "\"" . " title=\"Add New Record\" class=\"gridToolBarLink\"><img src=\"./images/defaultbutton/add.gif\" border=\"0\" /></a>";
    print "&nbsp;";
    print "                                </td>\n";
    print "                            </tr>\n";
    print "                        </table>\n";
    ...
    print "                            <a href=\"" . art_gen_url($qrystr[1], 1) . "\" class=\"gridColumnLink\">NetworkName</a>\n";
    if ($sort1 == "1") {
    ...
    print "                    <td class=\"gridColumn\"  NOWRAP >\n";
    print "                        <div class=\"gridColumnText\">\n";
    print "                            <a href=\"" . art_gen_url($qrystr[2], 1) . "\" class=\"gridColumnLink\">Enabled</a>\n";
    if ($sort2 == "1") {
    ...
    print "                    <td class=\"gridColumn\"  NOWRAP >\n";
    print "                        <div class=\"gridColumnText\">\n";
    print "                            <a href=\"" . art_gen_url($qrystr[3], 1) . "\" class=\"gridColumnLink\">SysDTStamp</a>\n";
    if ($sort3 == "1") {
    ...
    if ( ($numrows > 0) && ($result) ) {
        ...
        while ($row = mysql_fetch_array($result)){ 
            ...
            print "</td>\n";
            print "<td align=\"left\" >";
            $svalue = art_check_null( art_format_date( art_rowdata($row, 3) , "m/d/Y") );
            if ($svalue != "&nbsp;"){
                $svalue = htmlspecialchars($svalue);
            }
            print $svalue;
            ...
            print "<a href=\"" . "./fp_networks_edit.php". "?pm_fpNetworkID=" . art_rowdata_byname($row, $field_names, "fp_networks.fpNetworkID"). "\"" . " title=\"Edit\" target=\"_self\" class=\"gridBodyLink\">";
            ...
            print "</td>\n";
            print "<td align=\"center\" >";
            print "<a href=\"" . "./fp_networks_delete.php". "?pm_fpNetworkID=" . art_rowdata_byname($row, $field_names, "fp_networks.fpNetworkID"). "\"" . " title=\"Delete\" target=\"_self\" class=\"gridBodyLink\">";
        ...
        print "                    <td colspan=\"5\" ><div class=\"gridErrMsg\">" . $emptydatatext . "</div></td>\n";
        print "                </tr>\n";
    }
    print "            </table>\n";
    ...
    print "                    <td class=\"gridFooterBG\" colspan=\"5\">\n";
    if ( ($numrows > 0) && ($result) ){
        ...
        if ($navtype != ""){
            $pagename = "fp_networks";
            art_show_navigator($pagename, $navtype, $numrows, $page_size, $current_page, "fp_networks_ajax.php", 1, 0, $use_ajax, $folder_button_images);
        }
    } else {
    ...
    for ($i=1; $i <= $pagerecords; $i++){
        ...
        if ($del_id != ""){
            if ($j==0){
                ...
                $sqlDel = "DELETE FROM `fp_networks` WHERE ";
...
function art_groupdatagrid_display($field_names, $page_size, $current_page, $quick_search, $navtype, $category, $showtotalrec=0, $showpagesize=0) {	
    ...
    print "            <tbody>\n";
    print "                <tr>\n";
    print "                    <td class=\"gridColumn\" ><div class=\"gridColumnText\">NetworkName</div></td>\n";
    print "                    <td class=\"gridColumn\" ><div class=\"gridColumnText\">Enabled</div></td>\n";
    print "                    <td class=\"gridColumn\" ><div class=\"gridColumnText\">SysDTStamp</div></td>\n";
    ...
    if ( ($numrows > 0) && ($result) ){
        ...
        while ($row = mysql_fetch_array($result)){ 
            ...
            if (strcmp($group, $currgroup) != 0){
                ...
                print "                <tr>\n"; 
                print "                    <td colspan=\"5\" class=\"groupCaption\">\n"; 
