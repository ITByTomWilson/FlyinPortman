...
function art_sitemenu_display($forpage, $cssname){
    ...
    print "             <ul>\n";
    if ($forpage == "fp_activeusers" ){
        print "                 <li class=\"siteMenuSelected\">Users</li>\n";
    } else {
        print "                 <li><a href=\"" . "./fp_activeusers.php?clr_fp_activeusers=t&clr_fp_activeusers_adv_session=y". "\"" . " title=\"fp_activeusers\">Users</a></li>\n";
    }
    if ($forpage == "fp_rank" ){
        print "                 <li class=\"siteMenuSelected\">Ranks</li>\n";
    } else {
        print "                 <li><a href=\"" . "./fp_rank.php?clr_fp_rank=t&clr_fp_rank_adv_session=y". "\"" . " title=\"fp_rank\">Ranks</a></li>\n";
    }
    if ($forpage == "fp_networks" ){
