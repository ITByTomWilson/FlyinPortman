...
require_once './fp_networks_add_func.php';
...
<body>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
            <td>
                <form name="art_form" id="art_form" method="post" action="fp_networks_add.php"  style="margin: 0px; padding: 0px;">
