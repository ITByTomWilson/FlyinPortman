...
require_once './fp_allusers_const.php';
...
function art_gridtoolbar_display($category){
    ...
    $exportscript = "fp_allusers_dialog_pdf.php";
    ...
    $exportscript  = "fp_allusers_export_xls.php";
    $exporturl = "http://$hostname$currentpath/$exportscript";
...
function art_datagrid_display($field_names, $page_size, $current_page, $quick_search, $navtype, $category, $showtotalrec=0, $showpagesize=0) {	
    ...
    $qrystr = array_fill(0, 14, "");
    $clr = art_request("clr_fp_allusers", "");
    $clr_adv_session = art_request("clr_fp_allusers_adv_session", "");

    if (strtolower($clr) == "t"){
        art_clear_session("fp_allusers_sort1");	
        art_clear_session("fp_allusers_sort2");	
        art_clear_session("fp_allusers_sort3");	
        art_clear_session("fp_allusers_sort4");	
        art_clear_session("fp_allusers_sort5");	
        art_clear_session("fp_allusers_sort6");	
        art_clear_session("fp_allusers_sort7");	
        art_clear_session("fp_allusers_sort8");	
        art_clear_session("fp_allusers_sort9");	
        art_clear_session("fp_allusers_sort10");	
        art_clear_session("fp_allusers_sort11");	
        art_clear_session("fp_allusers_sort12");	
        art_clear_session("fp_allusers_sort13");	
        art_clear_session("fp_allusers_sort14");	
        $clr = "";
	  }

    if (strtolower($clr_adv_session) == "y") {
        $clr_adv_session = "";
        art_clear_session("fp_allusers_search");
        art_clear_session("fp_allusers_page");
        art_clear_session("fp_allusers_quick_search");
        art_clear_session("fp_allusers_category");
        $quick_search = "";
        $category = "";
	  }

    art_assign_session("fp_allusers_sort1", "");
    art_assign_session("fp_allusers_sort2", "");
    art_assign_session("fp_allusers_sort3", "");
    art_assign_session("fp_allusers_sort4", "");
    art_assign_session("fp_allusers_sort5", "");
    art_assign_session("fp_allusers_sort6", "");
    art_assign_session("fp_allusers_sort7", "");
    art_assign_session("fp_allusers_sort8", "");
    art_assign_session("fp_allusers_sort9", "");
    art_assign_session("fp_allusers_sort10", "");
    art_assign_session("fp_allusers_sort11", "");
    art_assign_session("fp_allusers_sort12", "");
    art_assign_session("fp_allusers_sort13", "");
    art_assign_session("fp_allusers_sort14", "");
    art_assign_session("fp_allusers_page_size", 100);
    art_assign_session("fp_allusers_page", "1");
...
FROM
  ...
  INNER JOIN fp_refYesNo fp_refYesNo6 ON (fp_userpermissions.admin = fp_refYesNo6.refEnabledID)"); 
    ...
    $sort1 = art_session("fp_allusers_sort1", "");
    $sort2 = art_session("fp_allusers_sort2", "");
    $sort3 = art_session("fp_allusers_sort3", "");
    $sort4 = art_session("fp_allusers_sort4", "");
    $sort5 = art_session("fp_allusers_sort5", "");
    $sort6 = art_session("fp_allusers_sort6", "");
    $sort7 = art_session("fp_allusers_sort7", "");
    $sort8 = art_session("fp_allusers_sort8", "");
    $sort9 = art_session("fp_allusers_sort9", "");
    $sort10 = art_session("fp_allusers_sort10", "");
    $sort11 = art_session("fp_allusers_sort11", "");
    $sort12 = art_session("fp_allusers_sort12", "");
    $sort13 = art_session("fp_allusers_sort13", "");
    $sort14 = art_session("fp_allusers_sort14", "");
    ...
    for ($i=1; $i<=14; $i++){
        $sorting = "";
        $sort_order = "";
        if (art_session("fp_allusers_sort".$i, "") == "1"){
            $sorting = "&fp_allusers_sort". $i . "=" . "2";
            $sort_order = "ASC";
        } else if (art_session("fp_allusers_sort".$i, "") == "2"){
            $sorting = "&fp_allusers_sort". $i . "=" . "1";
            $sort_order = "DESC";
        } else {
            $sorting = "&fp_allusers_sort". $i . "=" . "1";
            $sort_order = "";
        }
        $qrystr[$i] = "fp_allusers_ajax.php?clr_fp_allusers=t".$sorting;
    ...
    $advsearch_sql = art_session("fp_allusers_search","");
    if ($advsearch_sql != "") {
    ...
    print "                    <td class=\"gridHeaderBG\" colspan=\"14\">\n";
    ...
    print "<a href=\"" . art_gen_url("fp_allusers_ajax.php?clr_fp_allusers_adv_session=y", 1). "\"" . " title=\"Show All\" class=\"gridToolBarLink\"><img src=\"./images/defaultbutton/show_all.gif\" border=\"0\" /></a>";
    print "&nbsp;<a href=\"" . art_gen_url("fp_allusers_ajax.php?clr_fp_allusers=t", 1). "\"" . " title=\"Clear Sort\" class=\"gridToolBarLink\"><img src=\"./images/defaultbutton/clear_sort.gif\" border=\"0\" /></a>";
    print "&nbsp;";
    print "                                </td>\n";
    print "                            </tr>\n";
    print "                        </table>\n";
    ...
    print "                    <td class=\"gridColumn\"  NOWRAP >\n";
    print "                        <div class=\"gridColumnText\">\n";
    print "                            <a href=\"" . art_gen_url($qrystr[7], 1) . "\" class=\"gridColumnLink\">Email</a>\n";
    if ($sort7 == "1") {
    ...
    print "                    <td class=\"gridColumn\"  NOWRAP >\n";
    print "                        <div class=\"gridColumnText\">\n";
    print "                            <a href=\"" . art_gen_url($qrystr[13], 1) . "\" class=\"gridColumnLink\">Nintendo</a>\n";
    if ($sort13 == "1") {
    ...
    print "                    <td class=\"gridColumn\"  NOWRAP >\n";
    print "                        <div class=\"gridColumnText\">\n";
    print "                            <a href=\"" . art_gen_url($qrystr[14], 1) . "\" class=\"gridColumnLink\">Site Admin</a>\n";
    if ($sort14 == "1") {
        print "                            <a href=\"" . art_gen_url($qrystr[14] ,1) . "\" class=\"gridColumnLink\"><img src=\"./images/defaultbutton/sort_asc.gif\" border=\"0\" /></a>\n";
    } else if ($sort14 == "2"){
        print "                            <a href=\"" . art_gen_url($qrystr[14] ,1) . "\" class=\"gridColumnLink\"><img src=\"./images/defaultbutton/sort_desc.gif\" border=\"0\" /></a>\n";
    } else if (trim($sort14) == ""){
        print "                            <a href=\"" . art_gen_url($qrystr[14] ,1) . "\" class=\"gridColumnLink\"><img src=\"./images/defaultbutton/sort_none.gif\" border=\"0\" /></a>\n";
    }
    print "                        </div>\n";
    print "                    </td>\n";
    print "                </tr>\n";
    ...
    if ( ($numrows > 0) && ($result) ) {
        ...
        print "                    <td colspan=\"14\" ><div class=\"gridErrMsg\">" . $emptydatatext . "</div></td>\n";
        print "                </tr>\n";
    }
    print "            </table>\n";
    ...
    print "                    <td class=\"gridFooterBG\" colspan=\"14\">\n";
    if ( ($numrows > 0) && ($result) ){
        ...
        if ($navtype != ""){
            $pagename = "fp_allusers";
            art_show_navigator($pagename, $navtype, $numrows, $page_size, $current_page, "fp_allusers_ajax.php", 1, 0, $use_ajax, $folder_button_images);
        }
    } else {
...
FROM
  ...
  INNER JOIN fp_refYesNo fp_refYesNo6 ON (fp_userpermissions.admin = fp_refYesNo6.refEnabledID)"); 
    ...
    print "                    <td class=\"gridColumn\" ><div class=\"gridColumnText\">Email</div></td>\n";
    ...
    if ( ($numrows > 0) && ($result) ){
        ...
        while ($row = mysql_fetch_array($result)){ 
            ...
            if (strcmp($group, $currgroup) != 0){
                ...
                print "                <tr>\n"; 
                print "                    <td colspan=\"14\" class=\"groupCaption\">\n"; 
